                                            ...
                                            <table class="table align-middle table-nowrap">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="name">Montant</th>
                                                        <th class="sort" data-sort="description">Tax</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="montant"><?php echo $row['montant']; ?></td>
                                                        <td class="tax"><?php echo $row['tax']; ?></td>
                                                        <td>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div style="display: flex; align-items: center;flex-direction: column;">
                                                                    <img src="assets/images/orders/<?php echo ($row['image'] != '' ? $row['image'] : "no_image.jpg"); ?>" class="figure-img img-fluid rounded" alt="..." style="height: 250px; width: 80%;">
                                                                    <h3>Montant : <?php echo $row['montant']; ?></h3>
                                                                    <p>Tax : <?php echo $row['tax']; ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-light p-3">
                                                                    ...
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                                                                </div>                                                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="tablelist-form" autocomplete="off" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="live-preview">
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="mb-3">
                                                                                            <label for="montant" class="form-label">Montant <span style="color: red;">*</span></label>
                                                                                            <input type="text" class="form-control" name="montant" placeholder="Enter the product amount" id="montantinput" value="<?php echo $row['montant']; ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-12">
                                                                                        <div class="mb-3">
                                                                                            <label for="tax" class="form-label">Tax <span style="color: red;">*</span></label>
                                                                                            <input type="text" class="form-control" name="tax" placeholder="Enter tax amount" id="taxinput" value="<?php echo $row['tax']; ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                    <!--end col-->
                                                                                    <div class="col-md-12">
