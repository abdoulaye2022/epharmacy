    ...
    <div class="navbar-brand-box">
        ...
        <a href="dashboard.php" class="logo logo-dark">
            <span class="logo-sm">
                ...
                <img src="assets/images/Epharmacy_logo/Epharmacy_logo.png" alt="" height="50">
            </span>
            <span class="logo-lg">
                <h3 style="color: white; margin-top: 10px;">E-PHARMACY</h3>
                <img src="assets/images/Epharmacy_logo/Epharmacy_logo.png" alt="" height="50">
        ...
        <a href="dashboard.php" class="logo logo-light">
            <span class="logo-sm">
                <h3 style="color: white; margin-top: 10px;">E-PHARMACY</h3>
                <img src="assets/images/Epharmacy_logo/Epharmacy_logo_light.png" alt="" height="50">
            </span>
            <span class="logo-lg">
                <h3 style="color: white; margin-top: 10px;">E-PHARMACY</h3>
                <img src="assets/images/Epharmacy_logo/Epharmacy_logo_light.png" alt="" height="50">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarStatistics">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="statistics.php" class="nav-link"> Clients</a>
                            </li>
                            <li class="nav-item">
                                <a href="statistics.php" class="nav-link"> Orders</a>
                            </li>
                        </ul>
                    </div>
                </li>
